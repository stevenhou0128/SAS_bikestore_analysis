...
proc import datafile="/home/u63796147/ABC_Bikes.xlsx"
    dbms=xlsx
	out=ABC_BIKES
	replace;
	sheet="Products";
...
proc import datafile="/home/u63796147/woolyswheels_com_au.xlsx"
    dbms=xlsx
	out=Woolywheels
	replace;
	sheet="Products";
...
/* pdf report */
ods pdf file="/home/u63796147/Assignment_2_report.pdf" style=HTMLBlue;
ods noproctitle;
